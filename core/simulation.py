...
####################################################################################################    
####################################################################################################   
#DIFFUSION ON A CHAIN GRAPH (analogous to 1D finite difference)
####################################################################################################   
...
def WC_graph_propagators(Graph_Kernel='Gaussian',
...
def Graph_Wilson_Cowan_Model(E_0, I_0, Time=1000, Delta_t=0.01,
    ...
    for i in range(int(round(Time/Delta_t))):
        print(i)
        #currently SAME noise for excitatory and inhibitory
        ...
        E_Delta_t, I_Delta_t = WCLoop(E_0, I_0, 
           propagator_EE, propagator_IE, propagator_EI, propagator_II, 
                          Delta_t, d_e, d_i, P, Q, tau_e, tau_i, Noise_E, Noise_I)
